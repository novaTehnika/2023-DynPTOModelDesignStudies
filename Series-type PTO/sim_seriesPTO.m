function [out, exitCode] = sim_seriesPTO(y0,par)
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% sim_seriesfPTO.m function m-file
% AUTHORS:
...
%
% UPDATES:
% 1/4/2024 - Created from sim_parPTO.m.
% 
...
%% %%%%%%%%%%%%   POST-PROCESS   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    out.control.qpm_dpdtMin = [control(:).qpm_dpdtMin]';
    out.control.qpm_dpdtMax = [control(:).qpm_dpdtMax]';
    out.control.w_pm_dpdtMin = [control(:).w_pm_dpdtMin]';
    out.control.w_pm_dpdtMax = [control(:).w_pm_dpdtMax]';
...
%% Post-process analysis
    ...
    delta_p_pm = out.p_ro - out.p_hout;
    out.power.P_pmLoss = abs(abs(delta_p_pm.*out.q_pm) ...
                           - abs(out.Tpm.*out.w_pm));
    genMotor = out.Tgen.*out.w_pm >= 0;
    genGenerator = ~genMotor;
    out.power.P_gen = (genGenerator.*par.eta_g ...
                    + genMotor./par.eta_g) ...
                    .*(-out.Tgen).*out.w_pm;
    out.power.P_genLoss = abs(abs(out.Tgen.*out.w_pm) ...
                            - abs(out.power.P_gen));
