% study_parPTO_timeStepConvergence.m script m-file
% AUTHORS:
...
%
% This specific script studies the time step size used by the ode solver.
%
...
%
% UPDATES:
% 11/30/2023 - Created from study_parPTO_checkValves.m.
%
...
%% %%%%%%%%%%%%   Study Variables  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
nVar = 50;
MaxStep = logspace(log10(1e-5),log10(1e-3),nVar);% [m^3/s/Pa] valve coefficient for high-pressure outlet check valve
...
par.MaxStep = MaxStep(iVar);             % [s] for fixed time solver, this is the step size for solver
...
filename = ['data_parPTO_timeStepConvergence', ...
