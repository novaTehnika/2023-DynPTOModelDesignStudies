...
titleString = ['Parallel-Type Archetecture Performance with a Passive Resistve Element',newline,...
...
% ip = ip+1;
p(ip,iax) = semilogy(V_metric_opt,100*studyData(SS).L_rv(iiPareto),'Color',green,'Marker','*');
ip = ip+1;
...
% leg = legend('hyd. motor & generator','PRV at WEC-driven pump','PRV at RO inlet','resistive elem.','combined');
leg = legend('hyd. motor & generator','PRV at WEC-driven pump','resistive elem.','combined');
