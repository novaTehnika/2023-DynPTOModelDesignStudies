...
%
% UPDATES:
% 1/4/2024 - Created from run_parPTO.m.
%
...
par.control.p_h_nom = p_h_nom(SS); % [Pa]
...
legend('q_{hwp}','q_{hin}','q_{hout}','q_{pm}')
ax(2) = subplot(3,1,2);
...
xlabel('Time (s)')
ylabel('Flow rate (Lpm)')
legend('q_{ERUfeed}','q_{feed}','q_{perm}')
