% study_parPTO_accumNoDpDt_woPL_wPassiveRV.m script m-file
% AUTHORS:
...
%   SS=1;
%
% *** The purpose of this script is identical to 
% study_parPTO_accum_woPL_wPassiveRV.m except that the variable grid is
% changed for the design problem ignoring feed pressure dpdt. ***
%
% FILE DEPENDENCY:
% ./Parallel-type PTO/
...
%
% UPDATES:
% 1/22/2024 - Created from study_parPTO_accum_woPL_wPassiveRV.m
%
...
nVar2 = 10;
X = linspace(0.05,0.9,nVar2); % [-] accumulator volume distribution 1 - all at RO inlet, 0 - all at motor inlet
nVar3 = 20;
